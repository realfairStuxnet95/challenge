<nav id="menu" class="main-menu">
	<ul>
		...
		<li><span><a href="#0">Institutions</a></span>
			<ul>
				<li>
					<span><a href="#0">Ministries</a></span>
					<ul>
						<li>
							<a href="institution">
								MINALOC
						...
						<li>
							<a href="#" class="btn_1 rounded btn_1 outline" style="margin: 10px;">View More.</a>
						</li>
					</ul>
				</li>
				<li>
					<span><a href="#0">Public Institution</a></span>
					<ul>
						<li><a href="#">REB</a></li>
						<li><a href="#">RAB</a></li>
						<li><a href="#">RDB</a></li>
                ...
                <li><a href="#">A - Z Institution Listing</a></li>
			</ul>
		</li>
