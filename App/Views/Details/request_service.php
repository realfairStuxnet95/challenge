<aside class="col-lg-4" id="sidebar">
	<div class="box_detail booking">
		...
		<form method="post" action="assets/contact_detail.php" id="contact_detail" autocomplete="off">
			...
			<div class="form-group">
				<input type="submit" value="Request Service" class="add_top_30 btn_1 full-width purchase" id="submit-contact-detail">
			</div>
			<div class="text-center"><small>You can send us your request so we can proceed.</small></div>
		</form>
	</div>
